    ...
    return (
        ...
        <div className="navbar_container">
            ...
            <li className="navbar_list">
                <a href="/brandon_atkinson_portfolio/#top" className="no_list_style"> <ul className="navbar_item"> <img src={home_icon} className="navbar_icon" alt="home_icon"></img> <p className="navbar_text"> Explore </p></ul></a>
                <a href="/brandon_atkinson_portfolio/#about" className="no_list_style"> <ul className="navbar_item"> <img src={about_icon} className="navbar_icon" alt="about_icon"></img><p className="navbar_text"> About </p></ul></a>
                <a href="/brandon_atkinson_portfolio/#service" className="no_list_style"><ul className="navbar_item"> <img src={service_icon} className="navbar_icon" alt="service_icon"></img><p className="navbar_text"> Service </p></ul></a>
                <a href="/brandon_atkinson_portfolio/#portfolio" className="no_list_style"><ul className="navbar_item"> <img src={portfolio_icon} className="navbar_icon" alt="portfolio_icon"></img><p className="navbar_text"> Portfolio </p></ul></a>
                <a href="/brandon_atkinson_portfolio/#contact" className="no_list_style"><ul className="navbar_item"> <img src={contact_icon} className="navbar_icon" alt="contact_icon"></img><p className="navbar_text"> Contact </p></ul></a>
            </li>
